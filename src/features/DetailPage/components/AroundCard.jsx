...
export function AroundCard({ name, distance, type, lat, lng }) {
    ...
    return (
        <div
            className="shadow-bottom rounded-lg p-2 cursor-pointer hover:bg-gray-100 transition-colors duration-200"
            onClick={handleClick}
        >
            ...
            <p className="text-custom-font-gray mt-1">축제로부터 {distance}</p>
        </div>
    );
}
